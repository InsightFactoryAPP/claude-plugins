---
name: ml-engineer
description: "Use this agent when building production ML systems end-to-end - training pipelines, initial model serving/deployment, and automated retraining, from data validation through initial deployment. Hand off: inference-serving optimization on a deployed model -> machine-learning-engineer; ML platform/infra automation -> mlops-engineer; LLM/GenAI apps and evals -> ai-engineer; prompt text -> prompt-engineer."
